...
<div  class="container d-flex align-items-center justify-content-center">
    <div class="card bg-dark" style="width: 18rem;">
        ...
        <div class="card-body">
            ...
            <form action="">
                <textarea class="form-control bg-dark text-white" name="" id="" cols="30" rows="10">Merhaba, ben Şahin ERSEVER. 10 Ocak 1993 yilinda dünyaya geldim, İstanbul Beylikdüzünde yaşiyorum.</textarea>
